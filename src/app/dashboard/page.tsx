      ...
      <div className="mx-auto max-w-5xl">
        ...
        <header className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--surface)] px-4 py-2 text-xs font-semibold text-[var(--foreground)] transition-all hover:border-[var(--accent-primary)] disabled:opacity-50 shadow-sm"
          >
        ...
        <section aria-label="クイックアクション">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              { href: "/lpic1/practice", label: "コマンド練習", color: "#3fb950" },
              ...
              <Link
                key={action.href}
                href={action.href}
                className="flex flex-col gap-2 rounded-xl border border-[var(--border)] bg-[var(--surface)] p-4 text-center text-sm font-semibold transition-all hover:scale-105 hover:border-[var(--accent-primary)] shadow-sm"
