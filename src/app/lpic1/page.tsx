          ...
          <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-2 lg:grid-cols-3">
            {categories.map((cat) => (
              <Link
                ...
                className="flex items-center gap-4 rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-4 sm:p-5 transition-all duration-200 hover:border-[var(--accent-primary)] hover:bg-[var(--surface-2)] shadow-sm hover:shadow-md"
              >
                <div
